...
AgentWebX5 是一个基于[AgentWeb](https://github.com/Justson/AgentWeb) 4.1.4版本改造支持腾讯X5WebView ，仅支持androidx。极度容易使用以及功能强大的库，提供了 Android WebView 一系列的问题解决方案 ，并且轻量和极度灵活，体验请下载的 
[agentwebX5.apk](./agentweb.apk)，
